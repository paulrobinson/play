        ...
        extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.my.simple.jaxws.EchoServiceService.class.getName());
    ...
    static
    {
        ...
        {
            URL baseUrl;
            baseUrl = org.my.simple.jaxws.EchoServiceService.class.getResource(".");
