...
@XmlType(name = "", namespace = "http://test1", propOrder = {
    "orderperson",
    "shipto",
    "item"
})
public class SendMessage {
    ...
    @XmlElement(required = true)
    protected SendMessage.Shipto shipto;
    @XmlElement(required = true)
    protected List<SendMessage.Item> item;
     ...
     * @return
     *     possible object is
     *     {@link SendMessage.Shipto }
     *     
     */
    public SendMessage.Shipto getShipto() {
        return shipto;
    }
     ...
     *     
     */
    public void setShipto(SendMessage.Shipto value) {
        this.shipto = value;
    }
     ...
     * {@link SendMessage.Item }
     * 
     * 
     */
    public List<SendMessage.Item> getItem() {
        if (item == null) {
            item = new ArrayList<SendMessage.Item>();
        }
        return this.item;
    }
