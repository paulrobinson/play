 ...
 */
@WebServiceClient(name = "InjectionServiceService", targetNamespace = "http://my.org/simple", wsdlLocation = "http://localhost:8080/echo_service/EchoServiceImpl?wsdl")
public class InjectionServiceService
        extends Service
{

    private final static URL ECHOSERVICESERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(InjectionServiceService.class.getName());
    ...
    static
    {
        ...
        {
            URL baseUrl;
            baseUrl = InjectionServiceService.class.getResource(".");
    ...
    public InjectionServiceService(URL wsdlLocation, QName serviceName)
    {
        super(wsdlLocation, serviceName);
    }

    public InjectionServiceService()
    {
        super(ECHOSERVICESERVICE_WSDL_LOCATION, new QName("http://my.org/simple", "InjectionServiceService"));
    }
