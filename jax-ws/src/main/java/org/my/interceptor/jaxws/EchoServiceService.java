 ...
 */
@WebServiceClient(name = "InterceptedEchoServiceService", targetNamespace = "http://my.org/simple", wsdlLocation = "http://localhost:8080/echo_service/EchoServiceImpl?wsdl")
        ...
        extends Service
{
    ...
    {
        super(ECHOSERVICESERVICE_WSDL_LOCATION, new QName("http://my.org/simple", "InterceptedEchoServiceService"));
    }
