        ...
        extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.my.jaxws.EchoServiceService.class.getName());
    ...
    static
    {
        ...
        {
            URL baseUrl;
            baseUrl = org.my.jaxws.EchoServiceService.class.getResource(".");
